      ...
      <w:document 
        ...
        <w:body>
          <w:p>
            <w:r>
              <w:pict>
                <!-- VML Shape: width:10.5cm (half A4), inset="0.5cm,0.2cm,0.5cm,0.2cm" (0.5cm left/right margins), filled="f" (transparent), stroked="f" (no border) -->
                <v:rect style="position:absolute;margin-left:0pt;margin-top:0pt;width:10.5cm;height:200pt;z-index:251659264;v-text-anchor:top" filled="f" stroked="f">
                  <v:textbox style="mso-fit-shape-to-text:t;" inset="0.5cm,0.2cm,0.5cm,0.2cm">
                    <w:txbxContent>
                      ${paragraphsOoxml}
                    </w:txbxContent>
                  </v:textbox>
        ...
        try {
            ...
            await Word.run(async (context) => {
                ...
                try {
                    ...
                    const fullHtml = `<div lang="th-TH" xml:lang="th-TH" spellcheck="false" style="width: 10.5cm; max-width: 100%; padding: 0.2cm 0.5cm; box-sizing: border-box; font-family: '${settings.fontFamily}', 'TH Sarabun New', 'Angsana New', sans-serif; font-size: ${settings.fontSize}pt; text-align: justify; text-justify: inter-cluster; line-height: 1.6;">${cleanHtml}</div>`;
